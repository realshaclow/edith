export const ul94Protocol = {
  id: 'ul-94',
  title: 'UL 94 - Standardy Palności Plastików',
  description: 'Standardowy protokół UL do klasyfikacji palności plastików stosowanych w urządzeniach i aparaturze.',
  category: 'FIRE',

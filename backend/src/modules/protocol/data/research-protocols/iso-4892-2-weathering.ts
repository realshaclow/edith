export const iso4892Protocol = {
  id: 'iso-4892-2',
  title: 'ISO 4892-2 - Starzenie w Warunkach Sztucznej Pogody',
  description: 'Standardowy protokół do ekspozycji plastików na sztuczne źródła światła w urządzeniach starzeniowych.',
  category: 'WEATHERING',

export const iso3451Protocol = {
  id: 'iso-3451',
  title: 'ISO 3451 - Oznaczanie Zawartości Popiołu w Plastikach',
  description: 'Standardowa procedura gravimetrycznego oznaczania zawartości popiołu w plastikach przez spalenie w kontrolowanych warunkach.',
  category: 'chemical',
